...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.button_play_script.configure(image=_img1)
        ...
        self.button_save_as_project.configure(image=_img2)
        ...
        self.button_select_output.configure(image=_img3)
        ...
        self.button_reload_script_list.configure(image=_img4)
        ...
        self.button_clone.configure(image=_img5)
        ...
        self.button_rename_script.configure(image=_img6)
        self.button_rename_script.configure(compound='center')

        self.checkbutton_mute = ttk.Checkbutton(self.top)
        self.checkbutton_mute.place(x=882, y=119, width=58, height=21)
        ...
        self.button_select_video.configure(image=_img7)
        ...
        self.button_save_project.configure(image=_img8)
        ...
        self.label_issue = tk.Label(self.top)
        self.label_issue.place(x=792, y=500, height=13, width=92)
        self.label_issue.configure(activebackground="#d9d9d9")
        self.label_issue.configure(activeforeground="black")
        self.label_issue.configure(anchor='e')
        self.label_issue.configure(background="gray82")
        self.label_issue.configure(compound='left')
        self.label_issue.configure(cursor="hand2")
        self.label_issue.configure(disabledforeground="#9d9d9d")
        self.label_issue.configure(font="-family {Segoe UI} -size 8")
        self.label_issue.configure(foreground="#515151")
        self.label_issue.configure(highlightbackground="gray82")
        self.label_issue.configure(highlightcolor="black")
        self.label_issue.configure(text='''Report an issue''')

        self.label_about = tk.Label(self.top)
        self.label_about.place(x=890, y=500, height=13, width=48)
        self.label_about.configure(activebackground="#d9d9d9")
        self.label_about.configure(activeforeground="#a0a0a0")
        self.label_about.configure(background="gray82")
        self.label_about.configure(compound='left')
        self.label_about.configure(cursor="hand2")
        self.label_about.configure(disabledforeground="#9d9d9d")
        self.label_about.configure(font="-family {Segoe UI} -size 8")
        self.label_about.configure(foreground="#515151")
        self.label_about.configure(highlightbackground="gray82")
        self.label_about.configure(highlightcolor="black")
        self.label_about.configure(text='''About''')
        ...
        self.checkbutton_auto_rename.configure(compound='center')

        self.Label5 = tk.Label(self.top)
        self.Label5.place(x=10, y=500, height=20, width=466)
        ...
        self.button_restart_video.configure(image=_img9)
        ...
        self.button_record.configure(image=_img10)
        ...
        self.button_seek_back_10s.place(x=72, y=78, height=26, width=25
                , bordermode='ignore')
        ...
        self.button_seek_back_2s.place(x=96, y=78, height=26, width=25
                , bordermode='ignore')
        ...
        self.button_seek_2s.place(x=178, y=78, height=26, width=25
                , bordermode='ignore')
        ...
        self.button_seek_1f.place(x=154, y=78, height=26, width=25
                , bordermode='ignore')
        ...
        self.button_seek_back_10f.place(x=120, y=78, height=26, width=25
                , bordermode='ignore')
        self.button_seek_back_10f.configure(text='''-10f''')
        self.button_seek_back_10f.configure(compound='left')

        self.button_start_mark = ttk.Button(self.Labelframe1)
        self.button_start_mark.place(x=16, y=78, height=26, width=20
                , bordermode='ignore')
        photo_location = os.path.join(_location,"./icons/start_marker.png")
        global _img11
        _img11 = tk.PhotoImage(file=photo_location)
        self.button_start_mark.configure(image=_img11)
        self.button_start_mark.configure(compound='center')
        self.button_start_mark_tooltip = \
        ToolTip(self.button_start_mark, '''Start marker''')

        self.button_end_mark = ttk.Button(self.Labelframe1)
        self.button_end_mark.place(x=35, y=78, height=26, width=20
                , bordermode='ignore')
        photo_location = os.path.join(_location,"./icons/end_marker.png")
        global _img12
        _img12 = tk.PhotoImage(file=photo_location)
        self.button_end_mark.configure(image=_img12)
        self.button_end_mark.configure(compound='center')
        self.button_end_mark_tooltip = \
        ToolTip(self.button_end_mark, '''End marker''')
        ...
        self.button_play.configure(image=_img13)
        self.button_play.configure(compound='center')

        self.label_progress = tk.Label(self.Labelframe1)
        self.label_progress.place(x=13, y=59, height=19, width=174
                , bordermode='ignore')
        ...
        self.label_progress.configure(borderwidth="1")
        ...
        self.canvas_start_mark = tk.Canvas(self.Labelframe1)
        self.canvas_start_mark.place(x=120, y=41, height=18, width=2
                , bordermode='ignore')
        self.canvas_start_mark.configure(background="gray82")
        self.canvas_start_mark.configure(borderwidth="2")
        self.canvas_start_mark.configure(highlightbackground="#2e2e2e")
        self.canvas_start_mark.configure(highlightcolor="black")
        self.canvas_start_mark.configure(insertbackground="black")
        self.canvas_start_mark.configure(selectbackground="#d9d9d9")
        self.canvas_start_mark.configure(selectforeground="black")

        self.label_total_time = tk.Label(self.Labelframe1)
        self.label_total_time.place(x=207, y=59, height=19, width=149
                , bordermode='ignore')
        ...
        self.label_total_time.configure(borderwidth="1")
        ...
        self.canvas_end_mark = tk.Canvas(self.Labelframe1)
        self.canvas_end_mark.place(x=216, y=41, height=18, width=2
                , bordermode='ignore')
        self.canvas_end_mark.configure(background="gray82")
        self.canvas_end_mark.configure(borderwidth="2")
        self.canvas_end_mark.configure(highlightbackground="#2e2e2e")
        self.canvas_end_mark.configure(highlightcolor="black")
        self.canvas_end_mark.configure(insertbackground="black")
        self.canvas_end_mark.configure(selectbackground="#d9d9d9")
        self.canvas_end_mark.configure(selectforeground="black")

        self.scale_progress = ttk.Scale(self.Labelframe1, from_=0, to=1.0)
        self.scale_progress.place(x=17, y=43, height=14, width=335)
        self.scale_progress.configure(length="335")

        self.button_seek_10s = ttk.Button(self.Labelframe1)
        self.button_seek_10s.place(x=202, y=78, height=26, width=25
                , bordermode='ignore')
...
class ToplevelAbout:
    def __init__(self, top=None):
        ...
        _style_code()
        self.button_ok = ttk.Button(self.top)
        self.button_ok.place(x=79, y=201, height=26, width=68)
        self.button_ok.configure(text='''OK''')
        self.button_ok.configure(compound='left')

        self.Button2 = tk.Button(self.top)
        self.Button2.place(x=65, y=12, height=69, width=96)
        self.Button2.configure(activebackground="#d9d9d9")
        self.Button2.configure(activeforeground="black")
        self.Button2.configure(background="#b9b9b9")
        self.Button2.configure(disabledforeground="#9d9d9d")
        self.Button2.configure(font="-family {Segoe UI} -size 9")
        self.Button2.configure(foreground="black")
        self.Button2.configure(highlightbackground="#ff7376")
        self.Button2.configure(highlightcolor="black")
        photo_location = os.path.join(_location,"./icons/icon.png")
        global _img14
        _img14 = tk.PhotoImage(file=photo_location)
        self.Button2.configure(image=_img14)
        self.Button2.configure(overrelief="flat")
        self.Button2.configure(relief="flat")
        self.Button2.configure(text='''Button''')

        self.Label11 = tk.Label(self.top)
        self.Label11.place(x=42, y=162, height=21, width=149)
        self.Label11.configure(activebackground="#d9d9d9")
        self.Label11.configure(activeforeground="black")
        self.Label11.configure(background="gray82")
        self.Label11.configure(compound='left')
        self.Label11.configure(disabledforeground="#9d9d9d")
        self.Label11.configure(font="-family {Segoe UI} -size 9")
        self.Label11.configure(foreground="black")
        self.Label11.configure(highlightbackground="gray82")
        self.Label11.configure(highlightcolor="black")
        self.Label11.configure(text='''made by Ramiro Polla''')

        self.label_name = tk.Label(self.top)
        self.label_name.place(x=6, y=84, height=31, width=213)
        self.label_name.configure(activebackground="#d9d9d9")
        self.label_name.configure(activeforeground="black")
        self.label_name.configure(background="gray82")
        self.label_name.configure(compound='left')
        self.label_name.configure(cursor="hand2")
        self.label_name.configure(disabledforeground="#9d9d9d")
        self.label_name.configure(font="-family {Segoe UI} -size 14 -underline 1")
        self.label_name.configure(foreground="black")
        self.label_name.configure(highlightbackground="gray82")
        self.label_name.configure(highlightcolor="black")
        self.label_name.configure(text='''LiveMosher 1.0''')

        self.Label9 = tk.Label(self.top)
        self.Label9.place(x=40, y=114, height=21, width=150)
        self.Label9.configure(activebackground="#d9d9d9")
        self.Label9.configure(activeforeground="black")
        self.Label9.configure(background="gray82")
        self.Label9.configure(compound='left')
        self.Label9.configure(disabledforeground="#9d9d9d")
        self.Label9.configure(font="-family {Segoe UI} -size 9")
        self.Label9.configure(foreground="black")
        self.Label9.configure(highlightbackground="gray82")
        self.Label9.configure(highlightcolor="black")
        self.Label9.configure(text='''made by pawelzwronek''')

        self.Label10 = tk.Label(self.top)
        self.Label10.place(x=38, y=145, height=21, width=99)
        self.Label10.configure(activebackground="#d9d9d9")
        self.Label10.configure(activeforeground="black")
        self.Label10.configure(anchor='ne')
        self.Label10.configure(background="gray82")
        self.Label10.configure(compound='left')
        self.Label10.configure(disabledforeground="#9d9d9d")
        self.Label10.configure(font="-family {Segoe UI} -size 9")
        self.Label10.configure(foreground="black")
        self.Label10.configure(highlightbackground="gray82")
        self.Label10.configure(highlightcolor="black")
        self.Label10.configure(text='''a front-end for''')

        self.label_ffglitch = tk.Label(self.top)
        self.label_ffglitch.place(x=138, y=145, height=21, width=52)
        self.label_ffglitch.configure(activebackground="#d9d9d9")
        self.label_ffglitch.configure(activeforeground="black")
        self.label_ffglitch.configure(anchor='nw')
        self.label_ffglitch.configure(background="gray82")
        self.label_ffglitch.configure(compound='left')
        self.label_ffglitch.configure(cursor="hand2")
        self.label_ffglitch.configure(disabledforeground="#9d9d9d")
        self.label_ffglitch.configure(font="-family {Segoe UI} -size 9 -underline 1")
        self.label_ffglitch.configure(foreground="black")
        self.label_ffglitch.configure(highlightbackground="gray82")
        self.label_ffglitch.configure(highlightcolor="black")
        self.label_ffglitch.configure(text='''ffglitch''')
