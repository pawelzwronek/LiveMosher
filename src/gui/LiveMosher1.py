...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.button_play.configure(image=_img11)
        ...
        self.button_start_mark.configure(image=_img12)
        ...
        self.button_end_mark.configure(image=_img13)
        ...
        self.label_issue.place(x=822, y=500, height=13, width=114)
        ...
        self.label_issue.configure(foreground="black")
