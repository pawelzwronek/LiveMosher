...
# Dark background
# _ff_play_colors = {
#     12: 'Red',          # AV_LOG_ERROR | AV_LOG_FATAL | AV_LOG_PANIC
#     14: 'Yellow',       # AV_LOG_WARNING
#     7: 'Black',         # AV_LOG_INFO
#     10: 'BrightBlack',  # AV_LOG_VERBOSE | AV_LOG_DEBUG
#     8: 'White',         # AV_LOG_TRACE

#     13: 'Magenta',      # AV_CLASS_CATEGORY_MUXER
#     11: 'Cyan',         # AV_CLASS_CATEGORY_ENCODER
#     5: 'BrightBlue',    # AV_CLASS_CATEGORY_DEMUXER
#     9: 'BrightGreen',   # AV_CLASS_CATEGORY_BITSTREAM_FILTER
# }
            ...
            if code == 'm':  # "m" is "Set Graphics Mode"
                ...
                if value == '':
                    ...
                    try:
                        ...
                        print(f'Invalid ANSI code: {value}')
                        values = []
                    ...
                    while len(values) > 0:
                        ...
                        if value >= 300:
                            fg_color = _ff_play_colors.get(value - 300) or _ff_play_colors.get(7) # AV_LOG_INFO
                        if fg_color:
